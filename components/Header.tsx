...
const Header = ({ exhibitionScroll }: Props) => {
  ...
  useEffect(() => {
    if (windowSize.width) setShowNav(windowSize.width > 768);
  }, [windowSize.width]);
              ...
              {showNav && (
                <div className="pt-[3rem] md:p-0 md:space-y-0 space-y-2 md:flex md:flex-row flex-col md:space-x-6">
                  <div className="overflow-hidden">
                    ...
                    >
                      <span
                        className="cursor-pointer block md:flex font-poppins text-md md:text-lg text-gray-800 md:text-deep-sea font-light leading-8"
                        onClick={() => {
                          console.log(exhibitionScroll);
                          if (!isBrowser()) return;
                          if (exhibitionScroll - 100 <= 0) return;
                          window.scrollTo({
                            top: exhibitionScroll - 100,
                            behavior: "smooth",
                          });
                        }}
                      >
                  ...
                  <div className="overflow-hidden">
                    ...
                    >
                      <a
                        href="https://bulletin.seancfong.com/"
                        className="cursor-pointer block md:flex font-poppins text-md md:text-lg text-gray-800 md:text-deep-sea font-light leading-8"
                      >
                        bulletin
                      </a>
                  ...
                  <div className="overflow-hidden">
                    ...
                    >
                      <a
                        href="https://www.linkedin.com/in/seancfong/"
                        target="_blank"
                        rel="noreferrer"
                        className="cursor-pointer block md:flex font-poppins text-md md:text-lg text-gray-800 md:text-deep-sea font-light leading-8"
                      >
        ...
        {showBack && (
          ...
          >
            ...
            <div className="hidden md:flex">
              <button
                onClick={scrollToTop}
                className="font-poppins text-lg text-gray-500 font-light"
              >
                back to top
              </button>
            </div>
            ...
            {/* for smaller devices */}
            <div className="absolute -top-2 right-[8%] md:hidden md:p-0 p-1">
              <Link
                href="/#hero"
                className="font-poppins text-lg text-gray-500 font-light"
              >
